jQuery(document).ready(function($) {
    ...
    function initializeMap(image , painting_map_style, latitude, longitude, painting_zoom, companyname, description, el) {
        
        switch (painting_map_style) {
            case "wa_map_style1":
                var styles = [
                    {
                        "featureType": "all",
